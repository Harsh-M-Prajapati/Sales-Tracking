...
export class UserService {
  ...
  getProdcuts():Observable<Product[]>{
    return this.http.get<Product[]>(this.url+"employee/GetProducts").
  ...
  placeOrder(order:Order):Observable<ResponseMessage>{
    return this.http.post<ResponseMessage>(this.url+"employee/addOrder",order).
    pipe(catchError(this.handleError)) 
  }
